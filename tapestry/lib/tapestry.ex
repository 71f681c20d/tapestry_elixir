defmodule Tapestry do
  ...
  def start(_type, _args) do    # Builds the Tapestry topology
    ...
    case args do
      [num_nodes, _num_requests] ->
        ...
        #Enum.map(tl, fn x -> init_node(x, hd) end)         # topology is self-organizing. nodes only need to be initialized
  ...
  defp init_node(node, network_node) do
    Tapestry.Server.join_from(node, network_node)
  end
