  ...
  def start(_type, _args) do
    ...
    case args do
      [num_nodes, _num_requests] ->
        ...
        Tapestry.Server.join_from(fifth, thrd) #Timeout but correct fifth wants to join network
        #Tapestry.Server.join_from(thrd, fifth) #Works but incorrect, network joining fifth
